  ...
  <section class="bg-page-gradient flex flex-col md:min-h-screen">
    ...
    <div class="px-6 py-12 md:flex md:flex-1 md:items-center md:justify-center md:px-6 md:py-0">
      <div class="mx-auto w-full max-w-160">
        ...
        <form class="grid gap-5 rounded-2xl bg-light p-8" @submit.prevent="submit" @reset.prevent="resetForm">
          ...
          <p v-if="sent" class="m-0 font-semibold text-primary-dark">Hvala! Vaše povpraševanje je bilo poslano, kmalu se oglasimo.</p>
        </form>
      </div>
    </div>
  </section>
